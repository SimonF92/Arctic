...
def cast_to_map(simb_df):
    ...
    def create_map_labels():
        ...
        buoys_list=simb_df_full['buoy_id'].values.tolist()
        ...
        for buoy in buoys:
            cut = simb_df_full[simb_df_full['buoy_id']==buoy]
        ...
        for date,ice in zip(date_labels,ice_thickness_labels):
            full_label=(str(date)+ ' ' + str(round(ice,2)) + 'm')
    ...
    def produce_final_figure():
        ...
        cbar.set_label("Surface Temperature (degC)",size=30)
...
def fetch_and_map_data():
    #url='https://app.cryosphereinnovation.com/sbd_data/SIMB3_443910.csv'
    #url='https://app.cryosphereinnovation.com/sbd_data/SIMB3_859790.csv'
    #url='https://app.cryosphereinnovation.com/sbd_data/SIMB3_441910.csv'
